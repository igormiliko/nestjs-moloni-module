...
// ================== INVOICES ======================= //
export type TMoloni_InvoiceReceipts_Insert_BodyRequest = {
...
export type TMoloni_InvoiceReceipts_Update_BodyRequest = Partial<
  Omit<TMoloni_InvoiceReceipts_Insert_BodyRequest, 'company_id' | 'document_id'>
> & {
  company_id: number;
  document_id: number;
};

export type TMoloni_InvoiceReceipts_Delete_BodyRequest = {
  /** Identificador da empresa (obrigatório) */
  company_id: number;
...
export type TMoloni_InvoiceReceipts_GetAll_BodyRequest = {
  /** Identificador da empresa (obrigatório) */
  company_id: number;
...
export type TMoloniInvoiceReceiptsResponseItem = {
  /** Identificador do documento */
  document_id: number;
...
export type TMoloni_InvoiceReceipts_GetAll_BodyResponse =
  TMoloniInvoiceReceiptsResponseItem[];

export type TMoloni_InvoiceReceipts_Insert_BodyResponse = {
...
export type TMoloni_InvoiceReceipts_Update_BodyResponse = Partial<
  Omit<TMoloni_InvoiceReceipts_Insert_BodyResponse, 'document_id'>
>;

export type TMoloni_InvoiceReceipts_Delete_BodyResponse = {
  /** Indica se a operação foi válida (1) ou não (0) */
  valid: 1 | 0;
};
